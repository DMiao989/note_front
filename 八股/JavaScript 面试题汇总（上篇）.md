...
> 组合模式（伪经典模式）下的继承示意图：
>
> ![image-20210808102111003](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4550d93c80d64574854729dcdff963bd~tplv-k3u1fbpfcp-zoom-in-crop-mark:800:0:0:0.awebp)
>
> 圣杯模式下的继承示意图：
>
> ![image-20210808101303180](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d47742fb22584c429c83e45b7e6b06db~tplv-k3u1fbpfcp-zoom-in-crop-mark:800:0:0:0.awebp)
...
> 如下图：
>
> ![image-20210812161401493](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4c9b041b778440e895578fcf64761a42~tplv-k3u1fbpfcp-zoom-in-crop-mark:800:0:0:0.awebp)
>
...
>
> 例如：*A instanceof B*
> *instanceof* 用于检测对象 *A* 是不是 *B* 的实例，而检测是基于原型链进行查找的，也就是说 *B* 的 *prototype* 有没有在对象 *A* 的__*proto*__ 原型链上，如果有就返回 *true*，否则返回 *false*
...
>
> ![image-20210813134746501](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/52d4f819b8824955a7c5b42306ea8741~tplv-k3u1fbpfcp-zoom-in-crop-mark:800:0:0:0.awebp)
...
> 1. *toString*
>
> *toString( )* 是 *Object* 的原型方法，调用该方法，默认返回当前对象的 *[Class](https://juejin.cn/)* 。这是一个内部属性，其格式为 *[object Xxx]* ，其中 *Xxx* 就是对象的类型。
>
...
>
> ![image-20210813153833385](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3f177970e2924361902991e8910673cf~tplv-k3u1fbpfcp-zoom-in-crop-mark:800:0:0:0.awebp)
>
> 基本类型和引用类型的主要区别有以下几点：
>
> **存放位置：**
...
>
> ![image-20210813154040287](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9cbe609ed3174512b51e643e5d894226~tplv-k3u1fbpfcp-zoom-in-crop-mark:800:0:0:0.awebp)
>
> **值的可变性：**
>
...
### 81. *[Object.is](http://object.is/)* 方法比较的是什么

> 参考答案：
>
> *[Object.is](http://object.is/)* 方法是 *ES6* 新增的用来比较两个值是否严格相等的方法，与 === (严格相等)的行为基本一致。不过有两处不同：
>
> - +0 不等于 -0。
> - *NaN* 等于自身。
>
> 所以可以将*[Object.is](http://object.is/)* 方法看作是加强版的严格相等。
